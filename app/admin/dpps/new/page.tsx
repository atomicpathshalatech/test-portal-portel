      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <div>
            ...
            <select className="input" required value={form.chapter} onChange={(e) => setForm({ ...form, chapter: e.target.value })}>
        ...
        <div>
          <label className="label">Topic (optional, free text)</label>
          <input className="input" value={form.topic} onChange={(e) => setForm({ ...form, topic: e.target.value })} placeholder="e.g. Mole-Mass Relationship" />
        </div>

        <div className="grid grid-cols-2 gap-4">
          <div>
            <label className="label">Faculty (display name)</label>
            <input className="input" value={form.facultyName} onChange={(e) => setForm({ ...form, facultyName: e.target.value })} placeholder="By Firoz Sir" />
          </div>
          <div>
        ...
        <div>
          ...
          <input className="input" value={form.tags} onChange={(e) => setForm({ ...form, tags: e.target.value })} placeholder="NCERT, Important, Numerical" />
        </div>
